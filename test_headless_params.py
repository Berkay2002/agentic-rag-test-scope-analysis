...
def test_type_conversion():
    ...
    exit_code = run_headless(
        ...
        params={
            ...
            "google_model": "gemini-2.0-flash-exp"  # use valid model name
        }
    )
    ...
    if exit_code == 0:
        ...
        assert settings.google_model == "gemini-2.0-flash-exp", f"String assignment failed! Got {settings.google_model}"
